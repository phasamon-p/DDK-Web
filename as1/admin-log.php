                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                            data-bs-target="#collapseDepartmentAS1" aria-expanded="false"
                    ...
                    <form action="admin_db.php" method="post">
                        <div class="row mb-4">
                            <div class="col-xl-6 col-md-6">
                                ...
                                <input type="date" class="form-control" name="startdate" id="startdatepicker" value="">
                            </div>
                            <div class="col-xl-6 col-md-6">
                        ...
                        <div class="row mb-4">
                            <div class="btn-group col-xl-12 col-md-12">
                                <button type="submit" name="admin_log" class="btn btn-success">Search</button>
                            </div>
                        </div>
                </form>
                <div class="row mb-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (empty($row['date_logout'])){
                                        ...
                                        echo $row['date_logout'];
                                    } 
                                    ?>
                            </td>
                            <td>
                                <?php if (empty($row['time_logout'])){
                                        echo " - ";
                                    }else{
                                        echo $row['time_logout'];
                                    } 
                                    ?>
                            </td>
                        </tr>
